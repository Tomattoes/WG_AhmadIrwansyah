...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form method="post" action="sign-up3.php" class="text-center">
            <!-- <img class="mb-4" src="assets/brand/bootstrap-logo.svg" alt="" width="72" height="57"> -->
            <h1 class="h3 mb-3 fw-normal">sign up - 2</h1>
            <div class="card p-2">
                <h4 class="h6 mb-3 fw-normal">Mohon masukkan nama lengkap dan alamat Anda untuk melengkapi data diri Anda.</h4>
            </div>
            ...
            <div class="form-floating">
                <textarea type="text" name="alamat" class="form-control" id="floatingPassword" required></textarea>
